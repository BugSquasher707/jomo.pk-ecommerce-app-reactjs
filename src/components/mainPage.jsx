    ...
    return (
        ...
        <div className='wrapperDiv'>
            ...
            {searchBar && <div className="searchBar" style={searchBar ? mountedStyle : ''}>
                ...
                <HeaderSlider imgVal = {HomeData[1].sliderImgs} btnVal = {HomeData[1]}/>

                <div className='container-fluid mt-4'>

                    <div className="row border">
                            
                        <div className="col-6 img2 p-0">

                           <img src={HomeData[2].activeWear_apparel[0]} alt="" className='img1'/>

                        </div>

                        <div className="col-6 img2 p-0">

                            <img src={HomeData[2].activeWear_apparel[1]} alt="" className='img1 w-100 h-100'/>
                ...
                <div className='pt-5 pb-5' style={{width: '100%',margin: 'auto' , padding: '0px 10rem', boxSizing: 'border-box'}}>

                    <div className="row collectionRow1">
                            
                        <div className="col-6 column1">

                            <h1 className='collectionHeading'>{HomeData[3].mainCollection[0].collectionHeading}</h1>

                        </div>

                        <div className="col-6 column2">
                            
                            <ul className='collectionUl'>
                                
                                <li onClick={womanHideShow} className = {`${isWomanActive ? 'activeLi' : ''}`}>{HomeData[3].mainCollection[0].collectionItems[0]}</li>
                                <li onClick={manHideShow} className = {`${isManActive ? 'activeLi' : ''}`}>{HomeData[3].mainCollection[0].collectionItems[1]}</li>
                                <li onClick={kidHideShow} className = {`${isKidActive ? 'activeLi' : ''}`}>{HomeData[3].mainCollection[0].collectionItems[2]}</li>
                    ...
                    {womanShow && <MainCollection imgVal = {HomeData[3].mainCollection[1].women} imgSubTitle = {HomeData[3].mainCollection[2].womanImageSubTitle} styleState = {womanShow}/>}

                    {/* Man */}

                    {manShow && <MainCollection imgVal = {HomeData[3].mainCollection[1].men} imgSubTitle = {HomeData[3].mainCollection[2].manImageSubTitle} styleState = {manShow}/>}

                    {/* Kid */}

                    {kidShow && <MainCollection imgVal = {HomeData[3].mainCollection[1].kids} imgSubTitle = {HomeData[3].mainCollection[2].kidImageSubTitle} styleState = {kidShow}/>}
                ...
                <div className='container-fluid'>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 p-0">
                            ...
                            <Parallax bgImage={HomeData[4].endSeason} strength={-100} bgClassName='imageSize'>

                                <div className="endSeasonDiv"></div>
                ...
                <div className='trendingProductsSection mt-0 pt-5 pb-4' style={{width: '100%',margin: 'auto' , backgroundColor: '#F9F9F9', padding: '1rem', boxSizing: 'border-box'}}>

                    <div className="row collectionRow1">
                            
                        <div className="col-6 column1">

                            <h1 className='collectionHeading collectionHeading1'>{HomeData[5].headingTitle}</h1>

                        </div>

                        <div className="col-6 column2">
                            
                            <ul className='collectionUl collectionUl1'>
                                
                                <li onClick={footwearHideShow} className = {`${isFootwearActive ? 'activeLi' : ''}`}>{HomeData[5].productsCatagory[0]}</li>
                                <li onClick={apparelHideShow} className = {`${isApparelActive ? 'activeLi' : ''}`}>{HomeData[5].productsCatagory[1]}</li>
                                <li onClick={bagsHideShow} className = {`${isBagsActive ? 'activeLi' : ''}`}>{HomeData[5].productsCatagory[2]}</li>
                    ...
                    {footwearShow && <TrendingProductsSlider getSetImgSrc={getSetImgSrc} imgVal={Brands[1].Men[0].footWear[2].footWearSportCollection} styleState = {footwearShow} />}

                    {/* Apparel */}

                    {apparelShow && <TrendingProductsSlider getSetImgSrc={getSetImgSrc} imgVal={Brands[3].Men[0].Apparel[0].apparelTshirtCollection} styleState = {apparelShow}/>}

                    {/* Bags & Wallets */}

                    {bagsShow && <TrendingProductsSlider getSetImgSrc={getSetImgSrc} imgVal={Brands[3].Men[0].Bags[0].bagsCollection} styleState = {bagsShow}/>}
                ...
                <div className="container-fluid p-0">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            ...
                            <BrandsSlider imgVal={Brands[0].BrandLogo} headingVal = {HomeData[6].brandsTitle} />

                        </div>

                    </div>

                    <div className="row brandRow2">
