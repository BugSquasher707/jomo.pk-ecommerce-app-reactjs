...
function SubSliderBoysApperalMobile({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar20">
        <div className="row">
...
export default SubSliderBoysApperalMobile;
