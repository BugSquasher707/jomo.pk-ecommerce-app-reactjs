...
function SubSliderBoysMobileAccessor({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar21">
        <div className="row">
...
export default SubSliderBoysMobileAccessor;
