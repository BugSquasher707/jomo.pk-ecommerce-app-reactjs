...
function SubSliderBoysMobileBags({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar22">
        <div className="row">
...
export default SubSliderBoysMobileBags;
