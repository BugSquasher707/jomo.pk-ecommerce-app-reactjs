...
function SubSliderBoysMobileFootwear({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar19">
        <div className="row">
...
export default SubSliderBoysMobileFootwear;
