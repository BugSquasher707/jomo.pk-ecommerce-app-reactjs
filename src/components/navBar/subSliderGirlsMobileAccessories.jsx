...
function SubSliderGirlsMobileAccessor({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar17">
        <div className="row">
...
export default SubSliderGirlsMobileAccessor;
