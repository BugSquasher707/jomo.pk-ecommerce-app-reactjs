...
function SubSliderGirlsMobileBags({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar18">
        <div className="row">
...
export default SubSliderGirlsMobileBags;
