...
function SubSliderGirlsMobileFootwear({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar15">
        <div className="row">
...
export default SubSliderGirlsMobileFootwear;
