...
function SubSliderMenApperalMobile({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar8">
        <div className="row">
...
export default SubSliderMenApperalMobile;
