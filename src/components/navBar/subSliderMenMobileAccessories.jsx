...
function SubSliderMenMobileAccessories({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar9">
        <div className="row">
...
export default SubSliderMenMobileAccessories;
