...
function SubSliderMenMobileBags({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar10">
        <div className="row">
...
export default SubSliderMenMobileBags;
