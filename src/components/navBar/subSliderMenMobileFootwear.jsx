...
function SubSliderMenMobileFootwear({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar6">
        <div className="row">
...
export default SubSliderMenMobileFootwear;
