...
function SubSliderWomenApperalMobile({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar12">
        <div className="row">
...
export default SubSliderWomenApperalMobile;
