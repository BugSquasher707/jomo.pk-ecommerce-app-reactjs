...
function SubSliderWomenMobileAccessor({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar13">
        <div className="row">
...
export default SubSliderWomenMobileAccessor;
