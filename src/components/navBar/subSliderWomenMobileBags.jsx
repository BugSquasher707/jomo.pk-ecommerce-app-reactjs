...
function SubSliderWomenMobileBags({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar14">
        <div className="row">
...
export default SubSliderWomenMobileBags;
