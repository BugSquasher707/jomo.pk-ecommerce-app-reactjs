...
function SubSliderWomenMobileFootwear({footWearMenClose,headingTitle,liData}) {
  return (
    <div>
      <div className="container-fluid navBarSideBar11">
        <div className="row">
...
export default SubSliderWomenMobileFootwear;
